...
#[derive(Debug, Error)]
pub enum CliError {
    #[error("Could not find sqt project root.\nExpected to find 'sqt.yml' or 'models/' directory.\nHint: Run 'sqt init' to create a new project.")]
    ProjectRootNotFound,
