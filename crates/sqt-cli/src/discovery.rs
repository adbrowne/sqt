...
use rowan::TextRange;
use sqt_parser::File as AstFile;
...
pub struct ModelFile {
    ...
    pub parse_errors: Vec<sqt_parser::ParseError>,
}
...
impl ModelDiscovery {
    ...
    fn parse_model_file(&self, path: &Path) -> Result<ModelFile> {
        ...
        // Parse using sqt-parser
        let parse = sqt_parser::parse(&content);
...
"#;
        ...
        let parse = sqt_parser::parse(sql);
